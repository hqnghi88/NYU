...
global {
	...
	init {
        ...
        if (empty(bus_stop)) {
             ...
             create bus_stop number: 5 { location <- any_location_in(one_of(road)); }
        }
        ...
        create moto number: int(sim_capacity * r_moto) { location <- any_location_in(one_of(road)); }
        create gas_car number: int(sim_capacity * r_gas_car) { location <- any_location_in(one_of(road)); }
        create electric_car number: int(sim_capacity * r_ecar) { location <- any_location_in(one_of(road)); }
        create bus number: int(sim_capacity * r_bus) { location <- any_location_in(one_of(road)); }
        create scooter number: int(sim_capacity * r_scooter) { location <- any_location_in(one_of(road)); }
